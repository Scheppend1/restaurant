...
@Component({
    ...
    templateUrl: './rejectorder.component.html',
    styleUrls: ['./rejectorder.component.scss']
})
...
export class RejectorderComponent implements OnInit {
    ...
    getTodaySold() {
        this.appservice.getreport(this.startpagevalue,10,4,this.resid)
            .subscribe(
                data => {
                    if(data.status=='1'){
    ...
    handleChange(en){
        ...
        this.appservice.getreport(this.pno,10,4,this.resid)
        .subscribe(
            data => {
                if(data.status=='1'){
                    this.TodaySolddata = data.data;
    ...
    getrecord(){
        ...
        this.startDateValue=document.getElementById("startdate");
        this.endDateValue=document.getElementById("enddate");
        this.appservice.getreport(this.startpagevalue,this.totalrecord.value,4,this.resid)
        .subscribe(
            data => {
                if(data.status=='1'){
                    this.TodaySolddata = data.data;
