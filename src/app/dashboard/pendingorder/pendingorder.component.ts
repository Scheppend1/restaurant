...
export class PendingorderComponent implements OnInit {
    ...
    getTodaySold() {
        this.appservice.getreport(this.startpagevalue,10,1,this.resid)
            .subscribe(
                data => {
                    if(data.status=='1'){
    ...
    handleChange(en){
        ...
        this.startDateValue=document.getElementById("startdate");
        this.endDateValue=document.getElementById("enddate");
        this.appservice.getreport(this.pno,10,1,this.resid)
        .subscribe(
            data => {
                if(data.status=='1'){
                    this.TodaySolddata = data.data;
    ...
    getrecord(){
        ...
        this.startDateValue=document.getElementById("startdate");
        this.endDateValue=document.getElementById("enddate");
        this.appservice.getreport(this.startpagevalue,this.totalrecord.value,1,this.resid)
        .subscribe(
            data => {
                if(data.status=='1'){
                    this.TodaySolddata = data.data;
